...
@pytest.fixture
def uow_factory_mock(uow_mock: Mock, mocker: MockerFixture) -> Mock:
    return mocker.Mock(return_value=uow_mock)


@pytest.fixture
def executor(uow_factory_mock: Mock) -> TransactionExecutor:
    return TransactionExecutor(uow_factory=uow_factory_mock)
