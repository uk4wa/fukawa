...
async def test_create_organization_cmd_creates_domain_org_and_returns_public_id(
    ...
    debug_log = mocker.patch("pet.app.usecases.organizations.logger.debug")
    ...
    debug_log.assert_any_call("organization_create_started")
    debug_log.assert_any_call("organization_create_staged")
